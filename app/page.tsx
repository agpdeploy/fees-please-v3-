        ...
        {isSidebarOpen && (
          <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            <div className="w-[280px] bg-[#111] h-full relative flex flex-col border-l border-zinc-800 shadow-2xl animate-in slide-in-from-right duration-300">
              ...
              <div className="p-6 flex justify-between items-start border-b border-zinc-800 bg-zinc-900/50">
                ...
                <button onClick={() => setIsSidebarOpen(false)} className="text-zinc-500 hover:text-white transition-colors ml-4 shrink-0"><i className="fa-solid fa-xmark text-xl"></i></button>
              </div>
