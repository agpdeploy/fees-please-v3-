...
export default function Setup() {
  ...
  async function saveTeam() {
    ...
    const payload = { name: teamName, pin_code: teamPin || null, member_fee: memberFee, casual_fee: casualFee, primary_color: primaryColor, club_id: clubId, season_start: teamSeasonStart || null, season_end: teamSeasonEnd || null };
    let error;
