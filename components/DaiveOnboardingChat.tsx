    ...
    <div className="flex flex-col h-full w-full font-sans bg-white border-4 border-emerald-500 rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="p-4 bg-white border-t border-zinc-200 shrink-0">
        <form onSubmit={handleTextSubmit} className="flex gap-2">
          ...
          />
          <button type="submit" disabled={!localInput.trim() || phase !== 'NAME'} className="w-full py-3 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest text-white bg-emerald-600 hover:bg-emerald-500 rounded-xl transition-all shadow-md active:scale-95 disabled:opacity-50">
