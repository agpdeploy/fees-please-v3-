...
export default function Setup() {
  ...
  // Handle clearing the form if "Create New Club" is selected securely
  useEffect(() => { 
 ...
 // Refactored to safely distinguish between updating vs inserting, and auto-generate slugs
 async function saveConfig() {
    ...
    if (clubId && clubId !== 'new') {
      ...
      if (error) { 
        ...
        // Automatically make the creator the Club Admin of their new organization!
  ...
  return (
    <div className="animate-in fade-in duration-300 space-y-6 pb-20 relative">
      ...
      {/* Protective Wall: Don't show other tabs if we are trying to create a new club */}
