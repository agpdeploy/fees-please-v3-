...
async function run() {
  try {
    ...
    // Find RoundFixtureDiscoverTeamFragment
    const index = jsText.indexOf("fragment RoundFixtureDiscoverTeamFragment");
    console.log("Index of RoundFixtureDiscoverTeamFragment:", index);
    if (index !== -1) {
