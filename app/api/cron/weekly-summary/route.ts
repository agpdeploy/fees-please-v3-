            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
              <tr>
                ...
                <td align="right" valign="middle">
                  <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://feesplease.app'}/login" style="display: inline-block; background-color: #18181b; color: #ffffff; font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; padding: 10px 16px; border-radius: 8px; text-decoration: none;">Log In</a>
                </td>
              </tr>
            </table>
